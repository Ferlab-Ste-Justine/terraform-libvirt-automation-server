...
module "systemd_remote_configs" {
  source = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//systemd-remote?ref=v0.50.3"
  server = var.systemd_remote.server
  install_dependencies = var.install_dependencies
}

module "terraform_backend_etcd_configs" {
  source = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//terraform-backend-etcd?ref=v0.50.3"
...
module "pushgateway_configs" {
  source = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//pushgateway?ref=v0.50.3"
